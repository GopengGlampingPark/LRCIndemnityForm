...
SPREADSHEET_ID = '1T0RDEtBiavWqJjqbMf4IcHwCxfket3yMqVQybajGP4s'
...
def genbookid():
	if request.method == "POST":
		genbookid = generate_sequential_id("LRCBOOKID_")
...
######################################################################################################################## SHEET RELATED
def insert_to_sheet():
	C_UniqueID = generate_sequential_id("LRCID_")
...
def health_emails(clientID):
	...
	msg = Message(
			...
			recipients=['lrcputrajaya@gmail.com'],
		)
...
def submit_form(C_UniqueID):
	...
	form_docx_path = "reform/LRC_Form.docx"  # Path to the first document
	e_cert_docx_path = "e-certs/LRC_BOTcertificate2024.docx"  # Path to the second document
